  ...
  "skills": [
    {
      ...
      "installs": 123,
      "stars": 45,
      "createdAt": "2025-12-20T00:24:51.717Z",
      "updatedAt": "2026-01-17 16:02:30"
    }
  ],
  "total": 100,
  "limit": 10,
...
2. Include: name, namespace, description, author, sourceUrl, createdAt, updatedAt, stars, and installs
...
7. **CRITICAL:** You MUST display the last updated date for all skills found. If the updated date is within one month of the current date, you must heavily emphasize/highlight the date.
...
1. django-rest-framework-expert (@anthropics/claude-code/django-rest-framework-expert)
   Author: anthropics
   Source: https://github.com/anthropics/claude-code/tree/main/skills/django-rest-framework-expert
   Created: 2025-10-01 | Updated: 2026-03-04 (Within 1 month!)
